      ...
      <Container fluid> 
          ...
          <div className="sidebar-wrapper">
            ...
            <img src={Logo} srcSet={`${Logo2x} 2x,`} alt="FOXFrens IBC Autos-Compounder" className="p-4"/>
                ...
                <li>
                <Link to="/cosmoshub" onClick={() => this.setState({showNetworkSelect: true, name: 'cosmoshub'})}><img src={ATOM} className="chain-logo p-2"/> Cosmos <Badge bg="success">ACTIVE</Badge></Link>
                </li>
                <li>
          ...
          <p className="mb-4">
           ...
           <p className="mb-4">
            ...
            <ul className="mt-4">
              ...
              <li>Umee: umee19pqrxrl6n0g0mky4y79hlfzchprmsp5jp3yygg</li>
            </ul>
          </p>
          <hr />
